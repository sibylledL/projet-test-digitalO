...
var onFinished = __webpack_require__(66)
...
var _cors = __webpack_require__(80);

var _cors2 = _interopRequireDefault(_cors);

var _images = __webpack_require__(81);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = (0, _express2.default)(); //pb header
...
var port = 4567;
var dbUrl = "mongodb://localhost/imageTest_db";
...
//
//page d'accueil
var imgRouter = _express2.default.Router();
app.use('/', imgRouter);

imgRouter.get('/addimage', function (req, res) {
...
imgRouter.post('/addimage', upload.single('img'), function (req, res) {
  var newImg = new _images.Img(req.body);
  if (req.file) {
...
imgRouter.get('/showimage', function (req, res) {
  _images.Img.find({}, function (err, imgs) {
    if (err) throw err;
    res.json(imgs);
  });
});
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(9).concat(__webpack_require__(20)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
var Img = _mongoose2.default.model('Img', imgSchema);
exports.Img = Img;
